...
export function OrderTableFilters(){
    ...
    function handleFilter({ customerName, orderId, status }: OrderFiltersSchema) { // filtros escolhidos no form
        setSearchParams(state => { // seta parametros na url conforme filtros selecionados.
            if (orderId){
